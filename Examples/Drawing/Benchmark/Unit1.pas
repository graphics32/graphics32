...
uses
  SysUtils, Variants, Classes, Graphics, StdCtrls,
  Controls, Forms, Dialogs, GR32_Image, GR32_Paths, GR32, GR32_Polygons,
  GR32_Layers;
...
begin
  Memo1.Lines.Add(Format('[%s] %s: %d op/s', [cmbTest.Text, cmbRenderer.Text, OperationsPerSecond]));
end;
