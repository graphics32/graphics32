...
begin
  ...
  TransposeRegistry.Add(@@_Transpose32, @ReferenceTranspose32,          [isReference]).Name := 'ReferenceTranspose32';
  TransposeRegistry.Add(@@_Transpose32, @CacheObliviousTranspose32,     [isPascal],     -16).Name := 'CacheObliviousTranspose32';
  TransposeRegistry.Add(@@_Transpose32, @CacheObliviousTransposeEx32,   [isPascal],     -32).Name := 'CacheObliviousTransposeEx32';
...
{$if (not defined(PUREPASCAL)) and (not defined(OMIT_SSE2))}
  ...
  TransposeRegistry.Add(@@_Transpose32, @SuperDuperTranspose32,         [isSSE2],       -48).Name := 'SuperDuperTranspose32';
{$ifend}
