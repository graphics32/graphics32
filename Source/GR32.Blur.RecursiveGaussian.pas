...
{$ifdef IIR_BLUR_DEFAULT}
  ...
  BlurRegistry.Add(@@Blur32Proc,                  @RecursiveGaussianBlurRadius,         [isPascal]).Name := 'RecursiveGaussianBlurRadius';
  BlurRegistry.Add(@@GammaBlur32Proc,             @RecursiveGaussianBlurRadiusGamma,    [isPascal]).Name := 'RecursiveGaussianBlurRadiusGamma';
{$endif IIR_BLUR_DEFAULT}

  BlurRegistry.Add(@@HorizontalBlur32,            @RecursiveGaussianBlurHorizontalRadius, [isPascal]).Name := 'RecursiveGaussianBlurHorizontalRadius';
  BlurRegistry.Add(@@GammaHorizontalBlur32,       @RecursiveGaussianBlurHorizontalRadiusGamma, [isPascal]).Name := 'RecursiveGaussianBlurHorizontalRadiusGamma';

  BlurRegistry.Add(@@IIR_BlurFilterForward,       @BlurFilterForward_Pas,               [isPascal]).Name := 'BlurFilterForward_Pas';
  BlurRegistry.Add(@@IIR_BlurFilterBackward,      @BlurFilterBackward_Pas,              [isPascal]).Name := 'BlurFilterBackward_Pas';
  BlurRegistry.Add(@@IIR_BlurApplyEdgeCorrection, @BlurApplyEdgeCorrection_Pas,         [isPascal]).Name := 'BlurApplyEdgeCorrection_Pas';
...
{$ifdef IIR_BLUR_SIMD}
  ...
  BlurRegistry.Add(@@IIR_BlurFilterBackward,      @BlurFilterBackward_SSE41,            [isSSE41]).Name := 'BlurFilterBackward_SSE41';

{$endif IIR_BLUR_SIMD}

{$ifdef IIR_BLUR_EDGE_CORRECTION_SIMD}
  BlurRegistry.Add(@@IIR_BlurApplyEdgeCorrection, @BlurApplyEdgeCorrection_SSE41,       [isSSE41]).Name := 'BlurApplyEdgeCorrection_SSE41';
