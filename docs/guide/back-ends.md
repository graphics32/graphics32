...
Currently Graphics32 ships with the following back-end classes which are subclasses of [[TBackend]] and implement several interfaces (see below):
  ...
  * **Generic back-ends**
    ...
    * [[TMMFBackend]] (Windows only)
  * **Delphi back-ends (Windows GDI/VCL)**
    * [[TGDIBackend]] (default for [[TBitmap32]])
    * [[TGDIMMFBackend]]
    * [[TGDIMemoryBackend]]
...
::: info
Most of the platform backed methods and properties in [[TBitmap32]] query the back-end for the above interfaces.
