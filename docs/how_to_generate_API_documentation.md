...
- [x] **GR32.Blend.Modes**: `docs/api/GR32.Blend.Modes/index.md`
  - **Classes**:
    - [x] `TCustomGraphics32Blender`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/index.md`
      - **Methods**
        - [x] `Blend`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Methods/Blend.md`
        - [x] `BlendEx`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Methods/BlendEx.md`
        - [x] `GetPixelCombiner`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Methods/GetPixelCombiner.md`
        - [x] `ID`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Methods/ID.md`
        - [x] `Name`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Methods/Name.md`
      - **Properties**
        - [x] `Data`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32Blender/Properties/Data.md`
    - [x] `TCustomGraphics32ComponentBlender`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32ComponentBlender/index.md`
      - **Methods**
        - [x] `BlendComponents`: `docs/api/GR32.Blend.Modes/Classes/TCustomGraphics32ComponentBlender/Methods/BlendComponents.md`
    - [x] `TGraphics32ComponentBlender`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32ComponentBlender/index.md`
      - **Methods**
        - [x] `DoBlendComponent`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32ComponentBlender/Methods/DoBlendComponent.md`
        - [x] `DoBlendComponents`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32ComponentBlender/Methods/DoBlendComponents.md`
    - [x] `TGraphics32SeparableBlender`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32SeparableBlender/index.md`
      - **Methods**
        - [x] `BlendComponent`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32SeparableBlender/Methods/BlendComponent.md`
        - [x] `BlendComponents`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32SeparableBlender/Methods/BlendComponents.md`
    - [x] `TGraphics32BlenderNormal`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32BlenderNormal/index.md`
      - **Methods**
        - [x] `Blend`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32BlenderNormal/Methods/Blend.md`
        - [x] `GetPixelCombiner`: `docs/api/GR32.Blend.Modes/Classes/TGraphics32BlenderNormal/Methods/GetPixelCombiner.md`
  - **Interfaces**:
    - [x] `IGraphics32BlendEnumerator`: `docs/api/GR32.Blend.Modes/Interfaces/IGraphics32BlendEnumerator.md`
    - [x] `IGraphics32BlendGroup`: `docs/api/GR32.Blend.Modes/Interfaces/IGraphics32BlendGroup.md`
    - [x] `IGraphics32BlendGroupsEnumerator`: `docs/api/GR32.Blend.Modes/Interfaces/IGraphics32BlendGroupsEnumerator.md`
    - [x] `IGraphics32BlendGroups`: `docs/api/GR32.Blend.Modes/Interfaces/IGraphics32BlendGroups.md`
    - [x] `IGraphics32BlendService`: `docs/api/GR32.Blend.Modes/Interfaces/IGraphics32BlendService.md`
  - **Routines**:
