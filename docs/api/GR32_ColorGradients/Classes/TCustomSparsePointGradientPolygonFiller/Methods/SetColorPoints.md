...
parent: TCustomSparsePointGradientPolygonFiller
entity: TCustomSparsePointGradientPolygonFiller.SetColorPoints
kind: Method
...
Abstract virtual method configuring scatter vertex positions and colors for sparse point polygon fillers.
