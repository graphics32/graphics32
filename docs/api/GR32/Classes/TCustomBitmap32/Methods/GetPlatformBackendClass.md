...
`GetPlatformBackendClass` is a class method that returns the `TCustomBackend` derived class to use when the [[Create | constructor]] doesn't explicitly specify one.
