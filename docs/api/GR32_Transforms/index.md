...
- `TAffineTransformation`: Manages 2D rotation, scaling, skewing, and translation matrices.
- `TTransformation`: Abstract base class for 2D spatial coordinate mappings.
