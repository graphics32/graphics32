...
uses
  SysUtils, Classes, QGraphics, QControls, QForms, QDialogs, QMenus,
  QExtCtrls, JPeg, QExtDlgs, QStdCtrls, GR32, GR32_Image, GR32_Layers,
...
uses
  NewImageUnit, RGBALoaderUnit, Math, GR32_LowLevel, QPrinters;
