...
begin
  ...
  TransposeRegistry.Add(@@_Transpose32, @NoTransposeMoveLongword, [isReference]).Name := 'MoveLongword (no transpose)';
  TransposeRegistry.Add(@@_Transpose32, @NoTransposeMove, [isReference]).Name := 'Move (no transpose)';
