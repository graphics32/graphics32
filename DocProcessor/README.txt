...
Anything with a hyperlink will also have an entry in 'See Also', at least in the transformed webpages (in /Docs). To force a hyperlink addition to 'see Also' without referencing the link elsewhere in the webpage, use the following template - <p id="Hidden"><a href="YOUR_REF.htm"></a></p>.

Use the following markup to include code samples:

  <div class="Code"><pre class="brush: delphi;">
  //then add your code here, preferably without a newline char.;</pre></div>


2. The "Transform HTML" button converts bare-bones HTML in /Source
into properly linked and formatted HTML, complete with menus, JavaScripted code etc and
