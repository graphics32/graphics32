...
{$ENDIF}
  ...
  begin
    ...
    Bitmap.LoadFromFile(pathMedia + 'sprite_texture.bmp');
  end;
  ...
  begin
    ...
    LoadImage(Bitmap[0], pathMedia + 'sprite1.bmp', pathMedia + 'sprite1a.bmp');
    LoadImage(Bitmap[1], pathMedia + 'sprite2.bmp', pathMedia + 'sprite2a.bmp');
    LoadImage(Bitmap[2], pathMedia + 'sprite3.bmp', pathMedia + 'sprite3a.bmp');
  end;
