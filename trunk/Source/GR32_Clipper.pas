...
type
  ...
  private
    ...
    procedure InsertLocalMinimaIntoAEL(const BottomY: TFixed);
    ...
    function ProcessIntersections(const BottomY, TopY: TFixed): Boolean;
    procedure BuildIntersectList(const BottomY, TopY: TFixed);
...
procedure TClipper.InsertLocalMinimaIntoAEL(const BottomY: TFixed);
...
function TClipper.ProcessIntersections(const BottomY, TopY: TFixed): Boolean;
begin
  Result := True;
  try
...
procedure TClipper.BuildIntersectList(const BottomY, TopY: TFixed);
var
  e, eNext: PEdge;
  pt: TFixedPoint;
  isModified: Boolean;
...
begin
  ...
  for Index := 0 to FPolyOutList.Count - 1 do
    with POutRec(FPolyOutList[Index])^ do
